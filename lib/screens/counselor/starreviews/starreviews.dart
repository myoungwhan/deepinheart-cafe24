...
import 'progress_bar/progress_bar_layout.dart';
...
class StarReviewsHorizontal extends StatelessWidget {
  ...
  StarReviewsHorizontal({
    ...
    this.starNameStyle = const TextStyle(fontSize: 12),
    this.percentageStyle = const TextStyle(fontSize: 12),
    this.averageNumberTextStyle = const TextStyle(
      fontSize: 32,
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Row(
        crossAxisAlignment:
            this.alignReviewsCenter
                ? CrossAxisAlignment.center
                : CrossAxisAlignment.start,
        children: <Widget>[
          Column(
            children: <Widget>[
              Text(this.average.toString(), style: this.averageNumberTextStyle),
              StarDisplay(
                value: this.average,
                size: starSize,
